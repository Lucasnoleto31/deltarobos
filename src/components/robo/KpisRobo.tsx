 ...
 * losses") saíram: a definição de cada métrica está na metodologia.
 */
  ...
  return (
    <div className="space-y-3">
      ...
      <dl className="painel grid overflow-hidden sm:grid-cols-2 sm:[&>div:nth-last-child(-n+2)]:after:hidden">
        <LinhaKpi rotulo="Média mensal" detalhe={`${k.nMeses} ${k.nMeses === 1 ? "mês" : "meses"}`}>
        ...
        <LinhaKpi rotulo="Maior sequência de dias negativos" detalhe={`de positivos: ${k.maiorSequenciaDiasPositivos}`}>
