  ...
  return (
    <div className="conteudo space-y-8 py-8">
      ...
      {colunas.length === 0 ? (
        ...
        <>
          {/* Os ids continuam sendo âncoras de link direto (#lado-a-lado, #quem-rendeu-mais,
              #todos-juntos, #mes-a-mes) mesmo sem a barra de traços, que saiu em 20/09/2026. Quem tira
              o título de baixo do cabeçalho fixo é o scroll-padding-top do html (globals.css), então
              aqui não entra scroll-mt (19/09/2026). */}
